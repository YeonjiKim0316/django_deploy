...
class Post(models.Model):
    ...
    # 변경하면 출력은 되지만 화면단에는 마크다운이 나오지 않습니다
...
# Comment 클래스 구현 - Post 밑에 만듭니다. - admin에 등록해서 확인
class Comment(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE) # 하나의 포스트에 여러 댓글 쓸 수 있음
    author = models.ForeignKey(User, on_delete=models.CASCADE) # 여러사람이 하나의 댓글창에 댓글 쓸 수 있음
    content = models.TextField()
